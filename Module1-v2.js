...
// find out the top 3 products from electronics category
const topElectronicProducts = rawApiData
    .filter((item) => item.category === "Electronics")   // filter by category name
    .sort((a, b) => b.rating - a.rating)   // sorting by rating =>  to get high to low rating
    .slice(0, 3)          // sliced and get the top 3 top rating product
    .map((item) => {
